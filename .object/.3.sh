...
clear;toilet -t -f mono12  "Descodia-king" --gay -F border
echo ""
PUT 11 40
echo -e "\e[92mBy\e[1;93m RajAryan\e[1;95m /\e[1;96m Descodia "
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36mRaj Aryan \e[93m/ \e[100;92m[0m"
echo
...
sed -e "s/\Descodia/$name/g" .Descodia .zsh-theme > $HOME/.oh-my-zsh/themes/Descodia.zsh-theme
